...
var winOnce = false;
var documentWidth = window.screen.width/3;
var documentHeight = window.screen.height/3;
...
function updateBoardView(){
    ...
    for(var i=0;i<4;i++){
        for(var j=0;j<4;j++){
            ...
            $("#grid-container").append('<div class = "number" id = "number-'+i+'-'+j+'"></div>');
            //取得id为number-i-j的元素
    ...
    $('.number').css('line-height',cellSideLength+"px");
...
function showNumberWithAnimation(randomX,randomY,randomNumber){
    var numberCell = $("#number-"+randomX+"-"+randomY);
    //添加新的数字
